...
TICKET_COLUMNS = """
    ...
    metric_record_id, metric_id, metric_version_number, agent_id,
...
class TicketRepository(BaseRepository):
        ...
        self.session.execute(
            text(
                ...
                INSERT INTO evaluation_tickets (
                    ...
                    metric_version_number, agent_id, metric_snapshot_json,
                ...
                VALUES (
                    :id, :job_id, :payload_id, :source_dataset_id, :source_payload_ref,
                    :source_payload_id, :metric_record_id, :metric_id,
                    :metric_version_number, :agent_id,
    ...
    def recover_expired_leases(self, *, limit: int) -> list[EvaluationTicket]:
    ...
    def cancel_running_for_cancelled_jobs(self, *, limit: int) -> list[EvaluationTicket]:
        rows = self._all(
            """
            UPDATE evaluation_tickets t
            SET status = 'CANCELLED',

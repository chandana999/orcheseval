...
from evalorch.core.metrics import TICKET_TRANSITIONS, TICKETS_BY_STATUS, TICKETS_CLAIMED
from evalorch.models.entities import EvaluationTicket, JobProgress

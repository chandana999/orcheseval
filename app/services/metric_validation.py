"""Validation and normalization of a metric record's definition payload.

The normalized form is what gets frozen onto a ticket, so the runner can rely on
every metric having an explicit evaluator, check_type, priority, max_attempts,
and missing-context policy.
"""
